...
export const checkUnCheck = (prevSelections: string[], currentSelection: string) => {
...
export const filterBy = (data: HolidayHotelsType[], { type, value }: { type: string; value: string[]; }) => {
